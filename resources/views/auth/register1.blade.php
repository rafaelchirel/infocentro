                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('pregunta') ? ' has-error' : '' }}">
                            <label for="pregunta" class="col-md-4 control-label">Pregunta de seguridad</label>

                            <div class="col-md-6">
                                <input id="pregunta" type="text" class="form-control" name="pregunta" value="{{ old('pregunta') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('respuesta') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="respuesta" type="text" class="form-control" name="respuesta" value="{{ old('respuesta') }}" required autofocus>
