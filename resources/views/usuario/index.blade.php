...
@section('buscador')
    {!! Form::open(array('url'=>'usuario','method'=>'GET','autocomplete'=>'off','role'=>'buscar')) !!}
                                ...
                                <div class="col-xs-12 bottom text-center">
                                    <div class="col-xs-6 col-sm-6 emphasis" style="width: 100%;">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <a href="{{ route('usuario.show', $per->id) }}"><button type="button" class="btn btn-primary btn-xs">
