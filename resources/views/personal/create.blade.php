...
<div class="form-horizontal form-label-left">
    ...
    {!! Form::open(['route' => 'personal.store', 'method' => 'post', 'files' => true, 'id' => 'formulario']) !!}
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('telefono', null, ['class' => 'form-control has-feedback-left', 'placeholder' => '04262359685', 'id' => 'telefono', "maxlength=11", "minlength=11", "onpaste = 'return false'",  "onKeyPress='return SoloNumeros(event);'"]) !!}
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success == 'true') {
                        document.location.href = "{{ url('personal') }}";
                    }
                },
                error: function (data) {
