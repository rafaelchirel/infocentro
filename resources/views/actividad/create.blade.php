...
<div class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('nombre', null, ['class' => 'form-control has-feedback-left', 'placeholder' => 'Charla de Tecnologia', 'required', 'id' => 'cedula']) !!}
            <span class="fa fa-reorder form-control-feedback left"></span>
        </div>
    </div>

    <div class="item form-group">
        {!! Html::decode(Form::label('descripcion','Descripcion: *', ["class" => "control-label col-md-3 col-sm-3 col-xs-12"])) !!}
        <div class="col-md-6 col-sm-6 col-xs-12">
            <textarea name="descripcion" rows="2" cols="30" required="" class="form-control has-feedback-left" placeholder="Explicacion sobre el impacto de la tecnologia en la sociedad actual..."></textarea>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('fecha', null, ['class' => 'form-control has-feedback-left datepicker','readonly']) !!}
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::time('hora_inicio', null, ['class' => 'form-control has-feedback-left', 'min' => '00:00', 'max' => '24:00']) !!}
            <span class="fa fa-user form-control-feedback left"></span>
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::time('hora_salida', null, ['class' => 'form-control has-feedback-left', 'min' => '00:00', 'max' => '24:00']) !!}
            <span class="fa fa-user form-control-feedback left"></span>
        </div>
    </div>
