...
<div class="form-horizontal form-label-left">
    ...
    {!! Form::open(['route' => ['usuario.update', $personal->id], 'method' => 'put', 'files' => true, 'id' => 'formulario']) !!}
    ...
    <div class="text-center" id="titulo_rs">
        ...
        <div class="form-group text-center">
            <a href="{{ url('usuario') }}"><button type="button" class="btn btn-danger">Regresar</button></a>
    ...
    <script>
        ...
        $("#formulario").submit(function (e) {
            ...
            var route = "{{ url('usuario/' . $personal->id) }}";
